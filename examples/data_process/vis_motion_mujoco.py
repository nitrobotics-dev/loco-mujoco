...
def main(cfg : DictConfig) -> None:
    ...
    humanoid_xml = PATH_TO_MODELS/cfg.robot.mjcf_file
    ...
    motion_file = f"data/{cfg.robot.name}/{cfg.get('motion_name', '0-Transitions_mocap_mazen_c3d_airkick_jumpinplace_poses')}.pkl"
