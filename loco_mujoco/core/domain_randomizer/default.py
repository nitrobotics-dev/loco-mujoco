...
class DefaultRandomizer(DomainRandomizer):
    ...
    ########################Observations related randomization########################
    ...
    ########################PD Gains related randomization########################
